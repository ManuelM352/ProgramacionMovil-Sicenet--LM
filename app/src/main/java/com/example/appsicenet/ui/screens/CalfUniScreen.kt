...
@Composable
fun CalfUniScreen(navController: NavController, viewModel: ProfileViewModel) {
    val calificaciones = viewModel.calificacionesUnidades
    if (calificaciones != null && calificaciones.isNotEmpty()) {
        Column(modifier = Modifier.padding(16.dp)) {
            calificaciones.forEach { calificacion ->
                ...
                Text(text = "Calificación: ${calificacion.c1}")
                Text(text = "Calificación: ${calificacion.c2}")
